...
//
//public class RationalFunctionTmp<T extends Element<T>> extends AbstractElement<RationalFunctionTmp<T>> implements MathMap<ProjectivePoint<T>, ProjectivePoint<T>> {
...
//
//	public static <T extends Element<T>> RationalFunctionTmp<T> getEmbedding(T t, SmoothCurve<T> curve,
//			PolynomialRing<T> ring) {
//		return new RationalFunctionTmp<T>(curve.getField(), ring.getEmbedding(t),
//				ring.getEmbedding(curve.getField().one()), curve, ring);
//	}
//
//	public RationalFunctionTmp(Field<T> field, Polynomial<T> numerator, Polynomial<T> denominator, SmoothCurve<T> curve) {
...
//	}
//
//	public RationalFunctionTmp(Field<T> field, CoordinateRingElement<T> numerator, CoordinateRingElement<T> denominator,
...
//			numerator = cr.getEmbedding(r.divideChecked(numerator.getElement(), gcd));
//			denominator = cr.getEmbedding(r.divideChecked(denominator.getElement(), gcd));
//		}
...
//				List<Polynomial<T>> reducedBasis = r.generalQuotientAndRemainder(b, gcdBasis).getQuotients();
...
//			RationalFunctionTmp<T> f = new RationalFunctionTmp<>(field, denominator, numerator, curve, ring);
//			f.simplify();
...
//		if (!(O instanceof RationalFunctionTmp))
//			return false;
//		@SuppressWarnings("unchecked")
//		RationalFunctionTmp<T> f = (RationalFunctionTmp<T>) O;
...
//		String numeratorString = this.numerator.toString();
//		String denominatorString = this.denominator.toString();
//		if (numeratorString.contains(" ")) {
//			numeratorString = "(" + numeratorString + ")";
//		}
//		if (denominatorString.contains(" ")) {
//			denominatorString = "(" + denominatorString + ")";
//		}
//		return numeratorString + (this.denominator.equals(coordRing.one()) ? "" : ("/" + denominatorString));
//	}
//
...
//
//	@Override
//	public int compareTo(RationalFunctionTmp<T> f) {
//		return this.coordRing.multiply(this.numerator, f.denominator)
