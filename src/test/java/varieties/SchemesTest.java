...
public class SchemesTest {
	...
	void linesTest() {
		...
		AffineScheme<FFE> twoLines = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(Collections.singletonList(xy))));
	...
	void pointTest() {
		...
		list.add(xy);
		list.add(xpy);
		AffineScheme<FFE> doublePoint = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(list)));
	...
	void pointsTest() {
		...
		AffineScheme<FFE> point1 = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(list1)));
		...
		AffineScheme<FFE> point2 = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(list2)));
		...
		AffineScheme<FFE> point3 = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(list3)));
		...
		AffineScheme<FFE> point4 = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(list4)));
	...
	void intersectionTest() {
		...
		Polynomial<FFE> line = polynomialRing.add(polynomialRing.multiply(fq.subtract(fq.multiply(2, fq.alpha()), fq.one()), polynomialRing.getVar(1)),
				polynomialRing.multiply(fq.negative(fq.add(fq.one(), fq.alpha())), polynomialRing.getVar(2)), polynomialRing.getEmbedding(fq.add(fq.one(), fq.alpha())));
		AffineScheme<FFE> curve = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(Collections.singletonList(polynomial))));
		AffineScheme<FFE> l = new AffineScheme<>(fq,
				new CoordinateRing<>(polynomialRing, polynomialRing.getIdeal(Collections.singletonList(line))));
